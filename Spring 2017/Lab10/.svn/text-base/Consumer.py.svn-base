...
class Consumer(QMainWindow, Ui_MainWindow):
    ...
    def setupButtons(self):
        self.btnClear.clicked.connect(lambda: self.buttonClicked("C"))
        self.btnLoad.clicked.connect(lambda: self.buttonClicked("L"))
        self.btnSave.clicked.connect(lambda: self.buttonClicked("S"))
    ...
    def saveData(self):
        ...
        with open(fileName, 'w') as file1:
            ...
            while i < 20:
                if self.dataExist(listCN[i]) == True:
        ...
        for items in lines:
            if i == 2:
                ...
                if college[0] == "Aerospace Engineering":
                    ...
                    self.cboCollege.setCurrentIndex(0)
            elif i == 0 or i == 1 or i == 5 or i == len(lines)-1 or i == len(lines):
                x = 0
            else:
                words = items.split("\"")
